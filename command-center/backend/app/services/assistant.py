...
_SYSTEM = (
    ...
    "OBSIDIAN NOTES: The context may include notes from vaults the user flagged "
    "for you to read. When they ask you to pull deadlines, plans, or reminders "
    "from their notes into their planner, use that note content and add the "
    "items as tasks (see below).\n\n"
